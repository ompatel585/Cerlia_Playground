  ...
  return (
    ...
    <div className="bg-gray-900 text-white rounded-lg p-6 w-[95%] max-w-5xl shadow-lg">
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex flex-col w-full md:w-2/3 gap-6 bg-red-500 max-h-screen  scrollbar-thumb-rounded-full  scrollbar scrollbar-thumb-blue-900  overflow-y-scroll ">
          {/* Header Block */}

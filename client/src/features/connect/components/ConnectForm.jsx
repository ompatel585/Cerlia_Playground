...
//     if (!path || selectedMethods.length === 0) {
//       setError("Please select at least one method and enter a valid path.");
//       return;
//     }
...
//   // Fetch all existing routes once on mount
//   useEffect(() => {
...
//         setRoutes(data); // set all existing routes
//       } catch (err) {
...
//     try {
//       const data = await createRoute(path, selectedMethods);
//       setRoutes(data.routes); // update with latest routes including new one
//       setSelectedMethods([]);
//       setDropdownOpen(false);
//       setError(null);
//     } catch (err) {
